...
<form name="updatefrm" action="ResultService.jsp"  method="post">
    <!-- Content -->
    <div class="content">
       <%!
     Connection con = null;
...
<br><br><br>
<table border=1>
  <tr><td>Select Service</td><td><select name="servicetype">
<%  
try {
...
<option value="<%  out.println(rs.getString(4)); %>"><%  out.println(rs.getString(4)); %></option>
