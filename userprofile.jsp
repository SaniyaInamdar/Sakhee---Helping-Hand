    ...
    <div class="content">
        ...
        <div class="cards">
            ...
            <div class="card">
                ...
                <h3>Book Services</h3>
                <p>Find and book the services you need quickly.</p>
                <a href="ShowService.jsp">Book Now</a>
            </div>
            <!-- Card 2 -->
            <div class="card">
                <i class="fa fa-eye"></i>
                <h3>View Booking</h3>
                <p>Check the status of your current bookings.</p>
                <a href="viewbooking.jsp">View Details</a>
            </div>
            <!-- Card 3 -->
            <div class="card">
                <i class="fa fa-comments"></i>
                <h3>Make Complaint</h3>
                <p>Report issues or share your feedback.</p>
                <a href="usercomplaint.jsp">Submit Complaint</a>
            </div>
            <!-- Card 4 -->
