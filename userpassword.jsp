...
<body>
<form name="update" action="updatepassword.jsp">
    ...
    <header>
        ...
        <div>
		 <div class="change-password">
          ...
          <div class="logout">
                <a href="userpassword.jsp">Change Password</a>
            </div>
            <div class="logout">
...
<form name="update" action="savepassword.jsp">
			  
		 
<center>
<br><br><br>
<table border=1>
<tr><td>Enter Old Password</td><td><input type="text" id="oldpassword" name="oldpassword" value=""></td></tr>
<tr><td>Enter New Password</td><td><input type="text" id="newpassword" name="newpassword" value=""></td></tr> 
<tr><td>Confirm New Password</td><td><input type="text" id="confirmpassword" name="confirmpassword" value=""></td></tr>
<tr><td><input type="submit" value="Reset Password"></td><td><input type="reset" value="Clear"></td></tr>
</table> 
