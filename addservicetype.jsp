			...
			<div class="container">
				<div class="inner">
					<div class="row"> 
						...
						<div class="col-lg-6">
				<form class="form" method="post" action="save_type.jsp">
				<div class="row">
...
int serid=0;
     ...
     try {
        ...
        if(con!=null) {
           ...
           stmt = con.createStatement();
		    sql="select max(sertype_id) from service_type";
	...
	%>
												<input type="text" name="serviceId" placeholder="<% out.println(serid); %> " required="" style="width: 100%; padding: 15px; font-size: 16px;">
											</div> <!-- Username -->
										</div>
										<div class="col-lg-12">
											<div class="form-group">
